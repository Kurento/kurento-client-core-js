 ...
 * directoy a file with the GStreamer dot of the Media Element.
 ...
 * </ul>
 *
 * @alias module:core/abstracts.MediaElement.dumpGstreamerDot
 *
 * @param {module:core/complexTypes.GstreamerDotDetails} [details]
 *  Details of graph
 *
 * @param {module:core/abstracts.MediaElement~dumpGstreamerDotCallback} [callback]
 *
 * @return {external:Promise}
 */
MediaElement.prototype.dumpGstreamerDot = function(details, callback){
  var transaction = (arguments[0] instanceof Transaction)
                  ? Array.prototype.shift.apply(arguments)
                  : undefined;
  ...
  return disguise(this._invoke(transaction, 'dumpGstreamerDot', params, callback), this)
};
/**
 * @callback module:core/abstracts.MediaElement~dumpGstreamerDotCallback
 * @param {external:Error} error
 */
