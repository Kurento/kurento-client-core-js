 ...
 *
 * @param {module:kwsMediaApi/core~MediaPad.mediaDescriptionCallback} [callback]
 *
...
/**
 * The :rom:cls:`MediaElement` that encloses this pad
 *
 * @param {module:kwsMediaApi/core~MediaPad.mediaElementCallback} [callback]
 *
 * @return {module:kwsMediaApi/core~MediaPad}
 *  The own media object
 */
...
/**
 * Media that this pad accepts. One of :rom:attr:`MediaType.AUDIO`, :rom:attr:`MediaType.DATA` or :rom:attr:`MediaType.VIDEO`
 *
 * @param {module:kwsMediaApi/core~MediaPad.mediaTypeCallback} [callback]
 *
 * @return {module:kwsMediaApi/core~MediaPad}
 *  The own media object
 */
