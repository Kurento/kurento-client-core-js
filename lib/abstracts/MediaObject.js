 ...
 *
 * @abstract
 * @class module:core/abstracts.MediaObject
 */
...
/**
 * {@link MediaPipeline} to which this MediaObject belong, or the pipeline itself if invoked over a {@link MediaPipeline}
 *
...
/**
 * parent of this media object. The type of the parent depends on the type of the element. The parent of a {@link MediaPad} is its {@link MediaElement}; the parent of a {@link Hub} or a {@link MediaElement} is its {@link MediaPipeline}. A {@link MediaPipeline} has no parent, i.e. the property is null
 *
...
/**
 * @type module:core/abstracts.MediaObject.constructorParams
 */
MediaObject.constructorParams = {};

/**
 * @type module:core/abstracts.MediaObject.events
 */
