 ...
 *
 * @alias module:core.MediaPipeline.dumpGstreamerDot
 *
 * @param {module:core/complexTypes.GstreamerDotDetails} [details]
 *  Details of graph
 *
 * @param {module:core.MediaPipeline~dumpGstreamerDotCallback} [callback]
 *
 * @return {external:Promise}
 */
MediaPipeline.prototype.dumpGstreamerDot = function(details, callback){
  var transaction = (arguments[0] instanceof Transaction)
                  ? Array.prototype.shift.apply(arguments)
                  : undefined;
...
/**
 * @callback module:core.MediaPipeline~dumpGstreamerDotCallback
 * @param {external:Error} error
 */
